...
In this case I am reading the file within a subfolder of my working directory called 'data'. This is due to how things are set up for these online worksheets. However, if you were reading this csv file from within your working directory you would just use  `data <- read.csv("ChildReinforcement.csv")`.

```{r}
data <- read.csv("data/ChildReinforcement.csv")
```
