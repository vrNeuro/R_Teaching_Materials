...
```{R}
df <- read.csv("https://raw.githubusercontent.com/vrNeuro/R_Teaching_Materials/refs/heads/main/Presessional/CaffeineWords.csv")
```
...
df <- read.csv("CaffeineWords.csv") #load the data as a dataframe called df
```
