...
<!-- ![Figure 1: The R console](images/fig1_r_console.png){#fig-r-console fig-alt="The basic R console"} -->
...
<!-- ![Figure 2: The RStudio interface](images/fig2_rstudio_interface.png){#fig-rstudio-interface fig-alt="The default three-pane RStudio interface"} -->
...
<!-- ![Figure 3: The RStudio interface with source pane](images/fig3_source_pane.png){#fig-source-pane fig-alt="RStudio with the source pane open"} -->
...
<!-- ![Figure 4: Configuring RStudio](images/fig4_global_options.png){#fig-global-options fig-alt="The Global Options dialog box"} -->
...
<!-- ![Figure 5: The options menu](images/fig5_options_menu.png){#fig-options-menu fig-alt="RStudio settings" width="4.5in"} -->
...
<!-- ![Figure 6: The packages tab](images/fig6_packages_tab.png){#fig-packages-tab fig-alt="The Packages tab in RStudio"} -->

::: figure-placeholder
**\[FIGURE 6 PLACEHOLDER\]**

*Figure 6: The packages tab*
...
<!-- ![Figure 7: Installing packages](images/fig7_installing_packages.png){#fig-installing-packages fig-alt="The Install Packages dialog box" width="5.1in"} -->

::: figure-placeholder
**\[FIGURE 7 PLACEHOLDER\]**

*Figure 7: Installing packages*
...
<!-- ![Figure 8: Loading packages](images/fig8_loading_packages.png){#fig-loading-packages fig-alt="RStudio after loading the psych package"} -->

::: figure-placeholder
**\[FIGURE 8 PLACEHOLDER\]**

*Figure 8: Loading packages*
